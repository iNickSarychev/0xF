...
2. СТРУКТУРА И ФОРМАТИРОВАНИЕ:
   ...
   — СТРОГИЙ ЗАПРЕТ: НИКАКИХ текстовых меток секций типа "TL;DR:", "Механика:", "Вердикт:", "Архитектура:". Текст должен состоять просто из абзацев. Если видишь такие метки — REJECT.
   — Текст должен быть насыщенным и длинным (900-1500 знаков). 
...
4. СТРУКТУРА: Пиши просто абзацами. УДАЛЯЙ любые заголовки секций типа "TL;DR:", "Механика:", "Вердикт:". Только заголовок в начале и далее чистый текст.
