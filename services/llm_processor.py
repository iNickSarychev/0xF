...
class LLMProcessor:
    ...
    async def process_news_batch(
        ...
        prompt = f"""Ты — профессиональный переводчик и технический редактор.
...
3. Максимально ёмко изложи всю ключевую информацию, не теряя смысла.

ПРИОРИТЕТ ВЫБОРА:
{current_theme}

ХАРАКТЕРИСТИКИ ТЕКСТА:
- Объём: от 200 до 800 символов (старайся укладываться в 400 символов).
- Стиль: лаконичный, фактологический, без лишних рассуждений.
...
[Текст перевода, включающий всю ключевую информацию и детали]

ПРАВИЛА:
- Пиши ТОЛЬКО на русском языке.
- Первая строка ответа ОБЯЗАТЕЛЬНО: НОМЕР: N.
- Используй <b>жирный</b> для выделения. НИКАКОГО Markdown (##, **, #).
- Не теряй смысл и важные цифры/детали при сокращении.
